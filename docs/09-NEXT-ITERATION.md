...
| `Q-66` | Si el certificado digital de una sociedad está **a nombre de otro contribuyente**, ¿es siempre un error? Hoy sale en rojo y **no bloquea**: no me consta que no exista un caso legítimo (un representante, un grupo empresarial) y `§56` prohíbe meter un supuesto legal en el motor sin revisión jurídica. Si la respuesta es «siempre es un error», se convierte en una regla cruzada de la base | Con la revisión de `T-09` |
| `Q-65` | ¿Se puede facturar una campaña **en curso** —por adelantado o por hitos— o sólo al terminarla? Hoy el desplegable sólo ofrece las terminadas y cerradas. No es una limitación técnica: es una decisión comercial que nadie ha tomado, y ofrecerla en la pantalla sería darla por buena en silencio | Al primer cliente que pida un anticipo |
