...
| 9.17d | **Las credenciales de cada API en un solo sitio** (`DEC-033`, `docs/12`): hoy la de Decolecta vive en `fx_sources` y la de SUNAT hará falta en `9.9`. Prerrequisito de la facturación electrónica |
